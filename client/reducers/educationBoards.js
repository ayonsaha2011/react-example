import { ADD_EDUCATION_BOARD, DELETE_EDUCATION_BOARD, UPDATE_EDUCATION_BOARD, UPDATE_EDUCATION_BOARD_INDEX } from '../actions/types';
import findIndex from 'lodash/findIndex';

export default (state = [], action = {}) => {
  switch(action.type) {
    case ADD_EDUCATION_BOARD:
      ...
      case UPDATE_EDUCATION_BOARD_INDEX:
