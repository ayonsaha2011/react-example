...
import { getPost, UpdatePost, PostStoreUpdate } from '../../actions/educationBoardsActions';
...
class Edit extends React.Component {
  ...
  componentWillMount(){
    ...
    this.props.getPost(this.props.params.id)
                  .then(res => {
                    this.props.PostStoreUpdate(res.data);
  ...
  render() {
    document.title = "Eazyfyi - Education Board Edit";
...
export default connect(null, { getPost, PostStoreUpdate, UpdatePost, addFlashMessage })(Edit);
