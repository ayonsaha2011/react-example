...
import { PostList, newPost, Count, PostStoreUpdate, UpdatePost, deletePost } from '../../actions/educationBoardsActions';
...
class List extends React.Component {
  ...
  render() {
    document.title = "Eazyfyi - Education Board";
                  ...
                  <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                      <div className="card tableScrollCard">
                          <div className="header">
                              ...
                              <TooltipButton type="button" className="btn bg-purple waves-effect header-add-button" onClick={this.handleOnClickGo.bind(this, '/dashboard/education-boards/create')} tooltip='Add New' tooltipPosition="top" tooltipDelay={100}>
